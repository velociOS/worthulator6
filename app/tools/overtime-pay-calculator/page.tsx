        ...
        <section className="relative px-5 pt-2 pb-12 sm:px-8 lg:px-16">
          <div className="mx-auto max-w-5xl">
            ...
            <p className="mt-5 text-xs leading-relaxed text-gray-400">
              Estimates only — not financial or legal advice. Overtime rules vary by state and employer. Some roles and salary levels are exempt from FLSA overtime requirements. Check with your employer or HR for exact rates.
            </p>
          </div>
        </section>
      </div>
