        ...
        <section className="relative overflow-hidden border-b border-gray-100 bg-white px-5 py-16 sm:px-8 sm:py-24 lg:px-16">
          ...
          <div className="relative mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 mx-auto max-w-lg text-base leading-7 text-gray-500">
              See your net salary after income tax, National Insurance, and deductions. Enter your gross salary to instantly see your take-home pay.
            </p>
            <ul className="mt-6 inline-flex flex-col items-start gap-2 text-left mx-auto">
              {[
                "Covers Income Tax and National Insurance",
                "Supports personal allowance and standard deductions",
                "Works for annual, monthly, and weekly salaries",
              ].map((item) => (
