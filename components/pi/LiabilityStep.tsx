...
import { incidentTypes, type IncidentType } from "@/lib/pi/data";
import type { EvidenceStrength } from "@/lib/pi/factors";
...
const evidenceOptions: {
  ...
  },
  {
    value: "weak",
    label: "Weak",
    description: "Minimal evidence, conflicting accounts, disputed fault",
    icon: "❌",
  },
];
    ...
    <div className="space-y-10">
      ...
      <div>
        <label className="mb-1 block text-sm font-semibold text-slate-700">
          Your estimated fault in this incident
        </label>
        <p className="mb-4 text-xs text-slate-400">
          If you were partially at fault, this reduces your claim value. Be
          honest — courts and insurers will factor this in.
        </p>
        ...
        {faultPercent >= 50 && (
          <p className="mt-3 rounded-lg border border-amber-200 bg-amber-50 px-3 py-2 text-xs font-medium text-amber-700">
            At 50%+ fault your claim is significantly reduced and may be barred
            in some states (contributory negligence rules).
          </p>
        )}
      </div>
      ...
      <div>
        ...
        <p className="mb-4 text-xs text-slate-400">
          Better evidence leads to stronger settlement leverage.
        </p>
