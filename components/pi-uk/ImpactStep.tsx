...
import type { ImpactLevel } from "@/lib/pi-uk/factors";
...
const impactOptions: {
  ...
  },
  {
    ...
    description:
      "Permanent lifestyle changes. Unable to work or care for yourself as before.",
    icon: "🛑",
  },
];
    ...
    <div className="space-y-10">
      <div>
        ...
        <p className="mb-6 text-sm text-slate-500">
          This section captures general damages — pain, suffering and loss of
          amenity. These are non-financial but form a significant part of most
          UK personal injury claims. Be as accurate as possible.
        </p>
              ...
              return (
                <button
                  ...
                  className={`h-9 w-full rounded-lg text-xs font-bold transition-all ${
                    isSelected
                      ? `${color} scale-110 text-white shadow-md`
