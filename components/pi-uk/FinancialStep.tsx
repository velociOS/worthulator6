    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mb-6 text-sm text-slate-500">
          Enter your documented and projected financial losses. These are known
          as special damages and form the quantifiable part of your claim.
        </p>

        <div className="space-y-5">
          <CurrencyField
            label="Medical treatment costs to date"
            hint="All treatment costs incurred since the incident — hospital, physiotherapy, surgery, medication."
            value={medicalCosts}
            onChange={(v) => onChange({ medicalCosts: v })}
          />
          <CurrencyField
            label="Lost earnings to date"
          ...
          />
          <CurrencyField
            label="Future loss of earnings"
            hint="Projected loss of earning capacity if injuries affect your long-term ability to work."
            value={futureLoss}
